...
血浆渗透压包括晶体渗透压和胶体渗透压两部分，晶体渗透压占主要。而胶体渗透压中，由于白蛋白分子量小，微粒数多，故是胶体渗透压的主要成分。
...
\begin{itemize}
	...
	\item 如\SI{0.9}{\percent}\ce{NaCl}是等张溶液，\SI{1.9}{\percent}尿素等渗而不等张。
\end{itemize}
...
血浆pH的维持有赖于三个酸碱缓冲对：\ce{HCO3-}/\ce{H2CO3}、蛋白质阴离子/蛋白质、\ce{HPO4^{2-}}/\ce{H3PO4}。
