...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.4\linewidth]{脂滴.png}
	\caption{脂滴}
	\label{fig:脂滴}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\linewidth]{磷脂水解.png}
	\caption{甘油磷脂水解}
	\label{fig:磷脂水解}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{鞘磷脂水解}
	\caption{鞘磷脂水解}
	\label{fig:鞘磷脂水解}
\end{figure}
...
第一条途径耗能少，等效于2分子ATP，细菌、真核（PI、心磷脂）兼具此途径。（\autoref{fig:甘油磷脂合成1}）

第二条途径等效消耗3分子ATP，真核PC、PE、PS通过此途径。（\autoref{fig:甘油磷脂合成2}）

\begin{figure}[htbp]
	\centering
	\includegraphics[width=\linewidth]{甘油磷脂合成1}
	\caption{甘油磷脂合成1}
	\label{fig:甘油磷脂合成1}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.7\linewidth]{甘油磷脂合成2.png}
	\caption{甘油磷脂合成2}
	\label{fig:甘油磷脂合成2}
\end{figure}
...
\begin{enumerate}
	...
	\item 鲨烯$\longrightarrow$胆固醇（需要\ce{O2}）
\end{enumerate}
其中，“哈密瓜”CoA还原酶是关键酶。
